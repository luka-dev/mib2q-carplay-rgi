...
RENDERER_SRCS="main.c egl.c bitmap_map.c"
...
for f in $RENDERER_SRCS; do
    ...
    COMPILE_CMD="$COMPILE_CMD \
        /usr/qnx650/host/qnx6/x86/usr/bin/ntoarmv7-gcc -c -O2 -std=gnu99 -D__QNX__ -I$REMOTE_DIR -o $REMOTE_DIR/$obj $REMOTE_DIR/$f && "
done
