...
public class ClusterService implements NaviMoKoKDKConstants, PowerEventListener {
    ...
    public void setCombiBAPService(CombiBAPServiceNavi combiBAPServiceNavi) {
        ...
        this.combiBAPListener.setCombiService(combiBAPServiceNavix);
        this.combiBAPServiceNavi = combiBAPServiceNavix;
    }
    ...
    public void updateRgInfoForNextDestination(RgInfoForNextDestination rgInfoForNextDestination) {
        this.logChannel.log(100000000, "ClusterService#updateRgInfoForNextDestination(%1)", rgInfoForNextDestinationx);
        this.rgInfoForNextDestination = rgInfoForNextDestinationx;
        this.updateRgDirectionToNextDestination(rgInfoForNextDestinationx.getDirectionToNextDest());
    }
